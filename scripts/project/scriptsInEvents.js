...
const scriptsInEvents = {
		...
		async Globale_Event28_Act1(runtime, localVars)
		{
			window.showAd1();
		},

		async Globale_Event34_Act1(runtime, localVars)
		{
			PokiSDK.gameplayStop();
		},

		async Globale_Event34_Act2(runtime, localVars)
		{
			window.destroyAd1();
		},

		async Globale_Event109_Act3(runtime, localVars)
		{
			  PokiSDK.commercialBreak()
			   .then(() => {
		...
		async Globale_Event112_Act1(runtime, localVars)
		{
			PokiSDK.gameplayStop();
		},
		...
		async Globale_Event117_Act3(runtime, localVars)
		{
		...
		async Globale_Event126_Act2(runtime, localVars)
		{
			 PokiSDK.rewardedBreak().then(
		...
		async Globale_Event127_Act1(runtime, localVars)
		{
			PokiSDK.gameplayStop();
		},

		async Globale_Event131_Act2(runtime, localVars)
		{
			 PokiSDK.rewardedBreak().then(
